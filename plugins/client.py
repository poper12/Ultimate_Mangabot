...
class MangaClient(ClientSession, metaclass=LanguageSingleton):
    ...
    async def download_pictures(self, manga_chapter: MangaChapter):
        ...
        for picture in manga_chapter.pictures:
            ...
            for _ in range(3):
                req = await self.get_images(picture, file_name=file_name)
    ...
    async def get_images(self, url, file_name):
    ...
    async def get_picture(self, manga_chapter: MangaChapter, url, file_name):
        return await self.get_images(url, file_name)
